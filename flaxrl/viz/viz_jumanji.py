...
from envs.jumanji import JumanjInterface
...
if __name__ == "__main__":
    ...
    # env
    env = JumanjInterface.make(train_args.env_name)
    ...
    env.unwrapped.env.animate(state_seq, 100, f"{args.output}/{train_args.env_name}/animation.gif")
