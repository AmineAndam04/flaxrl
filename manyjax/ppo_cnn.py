...
def train(args):
    ...
    def update_step(update_state: tuple, _):  # noqa: PLR0915
        ...
        # reshape to (args.num_steps*num_envs,**) + shuffle + reshape to (number_of_possible_batches,batch_size,**)
...
def tb_logger(args, metrics, log_dir, num_updates):
    ...
    for start in range(0, len(completed_steps), args.num_envs):
        episode_steps = completed_steps[start : start + args.num_envs]
